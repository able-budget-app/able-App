...
window.PRODUCT_CAROUSELS = [
  ...
  { id: 'PC5', slug: 'product-tax-season', theme: 'white', slides: [
      { tpl: 'B', eyebrow: 'Swipe →',
        punch: "Tax season,\n{simplified.}",
        meta: '1 / 6' },
      { tpl: 'C', theme: 'page', eyebrow: 'Off the top', pos: 'right', shot: '11-tax-view',
        muted: "Every deposit.",
        punch: "Tax {set aside}\nfirst.",
        meta: '2 / 6' },
      { tpl: 'C', theme: 'page', eyebrow: 'Tag once', pos: 'left', shot: '13-tax-classify',
        muted: "Mark a deductible.",
        punch: "Able remembers\n{forever.}",
        meta: '3 / 6' },
      { tpl: 'C', theme: 'page', eyebrow: 'Find more', pos: 'right', shot: '12-deep-dive',
        muted: "12 months of history.",
        punch: "Bills you\n{forgot} you had.",
        meta: '4 / 6' },
      { tpl: 'C', theme: 'green', eyebrow: 'Export', pos: 'left', shot: '14-tax-export',
        muted: "April morning.",
        punch: "{One CSV.}",
        meta: '5 / 6' },
      { tpl: 'A', theme: 'green', eyebrow: 'mixed',
  ...
  { id: 'PC6', slug: 'product-slow-month', theme: 'glass-dark', slides: [
      { tpl: 'B', eyebrow: 'Swipe →',
        punch: "When the\n{slow month}\nhits.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'The fact',
        muted: "Income drops.",
        punch: "Bills\n{don't.}",
        meta: '2 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'Build it', pos: 'right', shot: '01-dashboard',
        muted: "Every deposit.",
        punch: "A slice to the\n{reserve.}",
        meta: '3 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'When you need it', pos: 'left', shot: '05-coach',
        muted: "Coach checks in.",
        punch: "Suggests the\n{move.}",
        meta: '4 / 7' },
      { tpl: 'C', theme: 'green', eyebrow: 'Result', pos: 'right', shot: '03-plan-bills',
  ...
  { id: 'PC7', slug: 'product-stop-doing', theme: 'green', slides: [
      { tpl: 'B', eyebrow: 'Swipe →',
        punch: "5 things you\n{stop} doing\nwith Able.",
        meta: '1 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'No 1', pos: 'right', shot: '01-dashboard',
        muted: "Stop holding",
        punch: "your {breath}\non the 1st.",
        meta: '2 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'No 2', pos: 'left', shot: '03-plan-bills',
        muted: "Stop bracing",
        punch: "for {bills.}",
        meta: '3 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'No 3', pos: 'right', shot: '05-coach',
        muted: "Stop guessing",
        punch: "if it'll\n{work out.}",
        meta: '4 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'No 4', pos: 'left', shot: '14-tax-export',
        muted: "Stop dreading",
        punch: "{April.}",
        meta: '5 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'No 5', pos: 'right', shot: '04-score',
  ...
  { id: 'PC8', slug: 'product-why-apps-fail', theme: 'glass-dark', slides: [
      { tpl: 'B', eyebrow: 'Swipe →',
        punch: "Why apps fail\n{variable income.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'Reason 1',
        muted: "They assume",
        punch: "a {paycheck.}",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'Reason 2',
        muted: "They want monthly.",
        punch: "Yours is\n{lumpy.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'Reason 3',
        muted: "They show",
        punch: "what {happened.}\nToo late.",
        meta: '4 / 7' },
      { tpl: 'C', theme: 'page', eyebrow: 'The fix', pos: 'right', shot: '02-allocation-flow',
        muted: "Per deposit.",
        punch: "Not per\n{month.}",
        meta: '5 / 7' },
      { tpl: 'C', theme: 'green', eyebrow: 'The fix', pos: 'left', shot: '04-score',
        muted: "Score reality.",
        punch: "Not the\n{plan.}",
        meta: '6 / 7' },
      { tpl: 'A', theme: 'green', eyebrow: 'mixed',
