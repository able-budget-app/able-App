...
window.POSTS = [
  ...
  { id: '90', slug: 'stat-half-skip-paying-themselves', cat: 'Stat', theme: 'green', tpl: 'A', eyebrow: 'business',
    ...
    punch: "go 2+ months without paying\n{themselves.}",
    meta: 'Kabbage, 2019' },
  ...
  // Sourced from docs/statistics.md. Each leads with a shocking number + Able reframe.
  { id: 'S01', slug: 'stat-77-million', cat: 'Stats', theme: 'glass-dark', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "77 million Americans",
    punch: "get paid differently\n{every month.}" },

  { id: 'S02', slug: 'stat-87-struggle', cat: 'Stats', theme: 'page', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "87% struggle to\nmanage their spending.",
    punch: "Not a discipline problem.\nA {structure} problem." },

  { id: 'S03', slug: 'stat-only-13-confident', cat: 'Stats', theme: 'white', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "Only 13% of Americans",
    punch: "feel {confident}\nabout their money." },

  { id: 'S04', slug: 'stat-60-freelancers', cat: 'Stats', theme: 'green', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "60% of freelancers",
    punch: "worry about\n{irregular} income." },

  { id: 'S05', slug: 'stat-91-worry-budget', cat: 'Stats', theme: 'glass-dark', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "91.8% of Americans",
    punch: "worry about\ntheir {budget.}" },

  { id: 'S06', slug: 'stat-89-month-swings', cat: 'Stats', theme: 'black', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "89% of US households",
    punch: "see their income\nswing {every} month." },

  { id: 'S07', slug: 'stat-88-million-crisis', cat: 'Stats', theme: 'glass-dark', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "88 million Americans",
    punch: "say they are\n{struggling} or in crisis." },

  { id: 'S08', slug: 'stat-69-want-track', cat: 'Stats', theme: 'green', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "69% want to\nstart tracking.",
    punch: "The intent is there.\nThe {tool} isn't." },
];
...
window.CAROUSELS = [
  ...
  { id: 'C167', slug: 'learn-business-credit-cards', theme: 'black', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'biz cards', size: 'md',
        ...
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'biz cards', size: 'md',
        muted: "Most: personal guarantee.",
        punch: "You {sign} for\nthe debt.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'biz cards', size: 'md',
        muted: "True business cards:",
        punch: "no PG. Need {PAYDEX 80+}\nand 2+ years.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'biz cards', size: 'md',
        muted: "Watch split reporting.",
        punch: "Pick cards that report\nto {business} bureaus.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'biz cards', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C168 — Grants: where to actually find them (green · funding)
  { id: 'C168', slug: 'learn-grants', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'grants', size: 'md',
        muted: "Free money exists.",
        punch: "But it takes\n{work.}",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'grants', size: 'md',
        muted: "Federal grants:",
        punch: "{grants.gov.}\nReal. Free to apply.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'grants', size: 'md',
        muted: "Corporate grants:",
        punch: "FedEx. Verizon.\n{Visa. Comcast.}",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'grants', size: 'md',
        muted: "Pay-to-apply?",
        punch: "{Scam.}\nReal grants don't charge.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'grants', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  { id: 'C169', slug: 'learn-personal-vs-business-credit', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        ...
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Business credit",
        punch: "follows the\n{business.}",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Strong business credit =",
        punch: "no personal {guarantees}\non loans.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "First 2-3 years:",
        punch: "lenders check {both.}",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C170 — SBA loans explained (glass · funding)
  { id: 'C170', slug: 'learn-sba-loans', theme: 'glass', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'SBA', size: 'md',
        muted: "SBA loans:",
      ...
      { tpl: 'A', eyebrow: 'SBA', size: 'md',
        ...
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'SBA', size: 'md',
        muted: "Not fast money.",
        punch: "Plan {60-90} days.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'SBA', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C171 — Setting up a fundable business (page · funding)
  { id: 'C171', slug: 'learn-fundable-business', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'setup', size: 'md',
        muted: "Before applying for funding,",
        punch: "your biz must {look like}\none.",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'setup', size: 'md',
        muted: "LLC + EIN.",
        punch: "{D-U-N-S} number.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'setup', size: 'md',
        muted: "Dedicated business",
        punch: "{bank account.}\nNever mix.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'setup', size: 'md',
        muted: "Address. Phone. Website.",
        punch: "Takes a {weekend.}\nUnder $500.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'setup', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  { id: 'C172', slug: 'learn-business-credit-bureaus', theme: 'glass-dark', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'bureaus', size: 'md',
        muted: "D&B (PAYDEX):",
        punch: "{1-100.}\nMost lenders use this.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'bureaus', size: 'md',
        muted: "Experian (Intelliscore):",
        punch: "1-100. {Larger}\nlenders pull this.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'bureaus', size: 'md',
        muted: "Step 1:",
  ...
  { id: 'C173', slug: 'learn-funding-roadmap', theme: 'green', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'roadmap', size: 'md',
        muted: "Month 1:",
        punch: "{fix} personal credit.\nBuild infrastructure.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'roadmap', size: 'md',
        muted: "Months 2-3:",
        punch: "Net-30 vendors.\n{PAYDEX} grows.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'roadmap', size: 'md',
        muted: "Months 4-6:",
        punch: "books, package,\n{apply.}",
  ...
  // ── REMAINING CREDIT + DEBT + PYF DEEP-CUTS (C174-C180) ──
  ...
  { id: 'C175', slug: 'learn-pull-credit-report', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        ...
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "annualcreditreport.com.",
        punch: "Free. {Federal.}\nThe only real source.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Pull one bureau",
        punch: "every {4 months.}\nYear-round monitoring.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "20% have errors.",
        punch: "Fixing yours =\n{20-50 points.}",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        punch: "Free for\n{30 days.}",
  ...
  // C176 — Build your debt payoff schedule (black · debt)
  { id: 'C176', slug: 'learn-debt-payoff-schedule', theme: 'black', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'payoff', size: 'md',
        muted: "Debt payoff:",
        punch: "{90-day} starter\nschedule.",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'payoff', size: 'md',
        muted: "Week 1:",
        punch: "list {every} debt.\nCan't solve unseen.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'payoff', size: 'md',
        muted: "Week 4:",
        punch: "build a {one-month}\nbuffer.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'payoff', size: 'md',
        muted: "Month 2:",
        punch: "call for {rate cuts.}\n30 min. Thousands saved.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'payoff', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C177 — Staying out of debt for good (glass · debt)
  { id: 'C177', slug: 'learn-stay-out-of-debt', theme: 'glass', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'habits', size: 'md',
        ...
        punch: "Can't? You can't {afford}\nwhat you bought.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'habits', size: 'md',
        muted: "Track net worth monthly.",
        punch: "One {number}\ntells you everything.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'habits', size: 'md',
        muted: "Leave room for",
        punch: "{guilt-free} spending.\nDeprivation budgets fail.",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'habits', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C178 — PYF definition / 3 rules (glass-dark · learn) — critique-context
  { id: 'C178', slug: 'learn-pyf-definition', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'PYF', size: 'md',
        muted: "Three rules",
        punch: "make {PYF}\nactually work.",
        meta: '1 / 5' },
  ...
  // C179 — Owner pay priority stack (page · learn)
  { id: 'C179', slug: 'learn-owner-pay-priorities', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'priorities', size: 'md',
        muted: "Owner pay landed.",
        punch: "Now {where}\ndoes it go?",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'priorities', size: 'md',
        muted: "Priority 1:",
        punch: "personal {emergency}\ncushion.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'priorities', size: 'md',
        muted: "Priority 2:",
        punch: "high-interest\n{debt.}",
  ...
  // C180 — Why you're not paying yourself (green · learn)
  { id: 'C180', slug: 'learn-not-paying-yourself', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'critique', size: 'md',
        muted: "Most entrepreneurs",
        punch: "are their own\n{last priority.}",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'critique', size: 'md',
        muted: "Contractors paid.",
        punch: "Tools paid. {You?}\nWhat's left.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'critique', size: 'md',
        muted: "5% beats 0%",
        punch: "by {infinity.}",
  ...
  // ── LANDING PAGE REPURPOSE (C181-C185) — from index.html hero/shift/HIW/stakes/final ──

  // C181 — Hero transformation (glass-dark · landing)
  { id: 'C181', slug: 'landing-breathe', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "From holding your breath",
        punch: "with {bills.}",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "To finally able",
        punch: "to {breathe.}",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'landing', size: 'md', noWordmark: true,
        muted: "Meet Able.",
        punch: "Built for the way\nyou {actually}\nget paid.",
        meta: '3 / 5' },
      { tpl: 'C', eyebrow: 'landing', size: 'md', shot: '01-dashboard', noWordmark: true,
        muted: "Bills + tax,",
  ...
  // C182 — Imagine this (green · landing)
  { id: 'C182', slug: 'landing-imagine-this', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "Imagine this.",
        punch: "A {check} comes in.",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'landing', size: 'md', noWordmark: true,
        muted: "You don't freeze.",
        punch: "You open\n{Able.}",
        meta: '2 / 5' },
      { tpl: 'C', eyebrow: 'landing', size: 'md', shot: '02-allocation-flow', noWordmark: true,
        muted: "It tells you immediately",
        punch: "what this {check}\nis for.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'landing', size: 'md',
  ...
  // C183 — How it works (white · landing)
  { id: 'C183', slug: 'landing-how-it-works', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "How it works:",
        punch: "Bills covered {first.}\nThen everything else.",
        meta: '1 / 5' },
      { tpl: 'C', eyebrow: 'landing', size: 'md', shot: '02-allocation-flow', noWordmark: true,
        muted: "When a deposit lands,",
        punch: "Able runs the\n{split.}",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "Bills. Debt.",
  ...
  // C184 — Cost of waiting (black · landing)
  { id: 'C184', slug: 'landing-cost-of-waiting', theme: 'black', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'stakes', size: 'md',
        muted: "A year:",
        punch: "up to {$12,000}\nyou didn't put to debt.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'stakes', size: 'md',
        muted: "Cost of starting?",
        punch: "{$14.99.}",
        meta: '4 / 5' },
      { tpl: 'A', eyebrow: 'stakes', size: 'md',
        punch: "Start your\n{30-day}\nfree trial.",
  ...
  // C185 — Become Able final transformation (page · landing)
  { id: 'C185', slug: 'landing-become-able', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'landing', size: 'md',
        muted: "From",
        punch: "{Unable.}",
        meta: '1 / 5' },
  ...
  { id: 'C186', slug: 'list-budget-breaks-reasons', theme: 'black', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'reason 2', size: 'md',
        muted: "2.",
        punch: "Monthly cadence,\n{lumpy} income.",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'reason 3', size: 'md',
        muted: "3.",
        punch: "\"Save 10%\" requires\nknowing the {number.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'reason 4', size: 'md',
        muted: "4.",
        punch: "{Slow months}\nare not handled.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'reason 5', size: 'md',
        muted: "5.",
        punch: "Tracks the {past.}\nNot the future.",
        meta: '6 / 7' },
      { tpl: 'A', eyebrow: '5 reasons', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C187 — 4 reasons per-deposit beats monthly (green · list)
  { id: 'C187', slug: 'list-per-deposit-beats-monthly', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '4 reasons', size: 'md',
        muted: "4 reasons per-deposit",
        punch: "beats {monthly.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'reason 1', size: 'md',
        muted: "1.",
        punch: "No waiting until\n{month-end.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'reason 2', size: 'md',
        muted: "2.",
        punch: "Slow months\n{handle themselves.}",
  ...
  // C188 — 5 tips for tax season as a freelancer (white · list)
  { id: 'C188', slug: 'list-tax-season-tips', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 tips', size: 'md',
        muted: "5 tips for tax season",
        punch: "as a {freelancer.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
        punch: "Set aside {25-35%}\nper deposit.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'tip 2', size: 'md',
        muted: "2.",
        punch: "{Quarterly} estimateds.\nQ1, Q2, Q3, Q4.",
        meta: '3 / 7' },
  ...
  // C189 — 6 mistakes 1099 earners make (glass-dark · list)
  { id: 'C189', slug: 'list-1099-mistakes', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '6 mistakes', size: 'md',
        muted: "6 mistakes",
        punch: "{1099 earners} make.",
        meta: '1 / 8' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
        punch: "No tax\n{set-aside.}",
        meta: '2 / 8' },
      { tpl: 'A', eyebrow: 'mistake 2', size: 'md',
        muted: "2.",
        punch: "Mixing {personal}\n+ business expenses.",
        meta: '3 / 8' },
      { tpl: 'A', eyebrow: 'mistake 3', size: 'md',
        muted: "3.",
        punch: "{Underpricing.}",
        meta: '4 / 8' },
      ...
      { tpl: 'A', eyebrow: 'mistake 5', size: 'md',
        muted: "5.",
        punch: "Tracking expenses\n{retroactively.}",
        meta: '6 / 8' },
      { tpl: 'A', eyebrow: 'mistake 6', size: 'md',
        muted: "6.",
  ...
  // C190 — 5 benefits of automating your floor (glass · list)
  { id: 'C190', slug: 'list-automating-floor-benefits', theme: 'glass', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'benefit 1', size: 'md',
        muted: "1.",
        punch: "Bills {never} miss.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'benefit 2', size: 'md',
        muted: "2.",
        punch: "Tax doesn't\n{surprise} you.",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'benefit 3', size: 'md',
        muted: "3.",
        punch: "Slow months\n{don't break} you.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'benefit 4', size: 'md',
        muted: "4.",
        punch: "You {stop} the\nbalance-check loop.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'benefit 5', size: 'md',
        muted: "5.",
        punch: "You {sleep}\nthrough Day 1.",
        meta: '6 / 7' },
      { tpl: 'A', eyebrow: '5 benefits', size: 'md',
  ...
  // ── MORE LIST-FORMAT CAROUSELS (C191-C201) — informative listicles ──

  // C191 — 5 reasons your debt isn't moving (black · reasons-negative)
  ...
  // C193 — 4 reasons automating beats discipline (glass · reasons-positive)
  { id: 'C193', slug: 'list-automating-beats-discipline', theme: 'glass', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '4 reasons', size: 'md',
        muted: "4 reasons automating",
        punch: "beats {discipline.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'reason 1', size: 'md',
        muted: "1.",
        punch: "Discipline {runs out}\nunder stress.",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'reason 2', size: 'md',
        muted: "2.",
        punch: "Decisions get worse\nwhen {tired.}",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'reason 3', size: 'md',
        muted: "3.",
        punch: "The system\n{never} has a bad day.",
  ...
  // C194 — 6 tips for managing inconsistent income (white · tips)
  { id: 'C194', slug: 'list-inconsistent-income-tips', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '6 tips', size: 'md',
        muted: "6 tips for managing",
        punch: "{inconsistent}\nincome.",
        meta: '1 / 8' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
      ...
      { tpl: 'A', eyebrow: 'tip 3', size: 'md',
        muted: "3.",
        punch: "Different bank\nfor {owner pay.}",
        meta: '4 / 8' },
      { tpl: 'A', eyebrow: 'tip 4', size: 'md',
        muted: "4.",
        punch: "Track by {deposit.}\nNot by month.",
        meta: '5 / 8' },
      { tpl: 'A', eyebrow: 'tip 5', size: 'md',
        muted: "5.",
        punch: "Pay cards {weekly.}\nNot at the due date.",
        meta: '6 / 8' },
      { tpl: 'A', eyebrow: 'tip 6', size: 'md',
        muted: "6.",
        punch: "Keep free spending\n{bounded.}",
        meta: '7 / 8' },
      { tpl: 'A', eyebrow: '6 tips', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
  ...
  // C195 — 5 tips for surviving a slow month (page · tips)
  { id: 'C195', slug: 'list-slow-month-tips', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 tips', size: 'md',
        muted: "5 tips for surviving",
        punch: "a {slow month.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
      ...
      { tpl: 'A', eyebrow: 'tip 2', size: 'md',
        muted: "2.",
        punch: "Defer non-essential.\n{Not} the bill.",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'tip 3', size: 'md',
        muted: "3.",
        punch: "Call for a rate cut.\n{3-5 points.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'tip 4', size: 'md',
        muted: "4.",
        punch: "Tax bucket\nstays {sacred.}",
  ...
  // C196 — 5 tips for handling a big check (white · tips)
  { id: 'C196', slug: 'list-big-check-tips', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 tips', size: 'md',
        muted: "5 tips for handling",
        punch: "a {big check.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
        punch: "Don't celebrate it\nas {spendable.}",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'tip 2', size: 'md',
        muted: "2.",
        punch: "Run the splits\n{first.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'tip 3', size: 'md',
        muted: "3.",
        punch: "Top up\nthe {reserve.}",
  ...
  // C197 — 5 tips for first-year freelancers (page · tips)
  { id: 'C197', slug: 'list-first-year-freelancer-tips', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 tips', size: 'md',
        muted: "5 tips for",
        punch: "{first-year} freelancers.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
        punch: "Separate {business}\naccount. Day 1.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'tip 2', size: 'md',
        muted: "2.",
        punch: "Tax bucket from\n{deposit 1.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'tip 3', size: 'md',
        muted: "3.",
        punch: "Track {all income.}\n1099 + cash + Venmo.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'tip 4', size: 'md',
        muted: "4.",
        punch: "Quarterlies.\n{No} April surprise.",
  ...
  { id: 'C198', slug: 'list-credit-score-mistakes', theme: 'glass-dark', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'mistake 2', size: 'md',
        muted: "2.",
        punch: "Missing a payment.\n{60-110} points.",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'mistake 3', size: 'md',
        muted: "3.",
        punch: "Utilization over\n{30%.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'mistake 4', size: 'md',
        muted: "4.",
        punch: "{5 hard pulls}\nin a weekend.",
  ...
  // C200 — 6 tax mistakes self-employed make (glass-dark · mistakes)
  { id: 'C200', slug: 'list-tax-mistakes', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '6 mistakes', size: 'md',
        muted: "6 tax mistakes",
        punch: "{self-employed}\npeople make.",
        meta: '1 / 8' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
  ...
  // C201 — 5 benefits of a smoothing reserve (glass · benefits)
  { id: 'C201', slug: 'list-reserve-benefits', theme: 'glass', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 benefits', size: 'md',
        muted: "5 benefits of",
        punch: "the {reserve.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'benefit 1', size: 'md',
        muted: "1.",
        punch: "Slow months stop\n{breaking} the floor.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'benefit 2', size: 'md',
        muted: "2.",
        punch: "Skipping bills =\n{impossible.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'benefit 3', size: 'md',
        muted: "3.",
        punch: "Surprises don't hit\nthe {card.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'benefit 4', size: 'md',
        muted: "4.",
        punch: "Quarterly tax\n{doesn't panic} you.",
  ...
  { id: 'C202', slug: 'list-save-20-doesnt-work', theme: 'black', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'reason 3', size: 'md',
        muted: "3.",
        punch: "Slow months tempt\nyou to {skip.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'reason 4', size: 'md',
        muted: "4.",
        punch: "Skipping {breaks}\nthe rule.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'reason 5', size: 'md',
        muted: "5.",
        punch: "Per-deposit %\nstays {consistent.}",
  ...
  // C203 — 4 reasons per-deposit tax beats April scramble (green · reasons-pos)
  { id: 'C203', slug: 'list-per-deposit-tax-reasons', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '4 reasons', size: 'md',
        muted: "4 reasons per-deposit tax",
        punch: "beats the {April}\nscramble.",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'reason 1', size: 'md',
        muted: "1.",
        punch: "The bucket fills\n{automatically.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'reason 2', size: 'md',
        muted: "2.",
        punch: "No surprise\n{April} number.",
  ...
  { id: 'C205', slug: 'list-negotiate-creditors-tips', theme: 'page', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
        punch: "Always call the\n{hardship} department.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'tip 2', size: 'md',
        muted: "2.",
        punch: "Ask for a rate cut.\n{3-5 points.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'tip 3', size: 'md',
        muted: "3.",
        punch: "Older debt settles\nfor {30-50%.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'tip 4', size: 'md',
        muted: "4.",
        punch: "Get every offer\n{in writing.}",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'tip 5', size: 'md',
        muted: "5.",
        punch: "Know your\n{FDCPA} rights.",
  ...
  // C206 — 5 tips for the bonus check (white · tips)
  { id: 'C206', slug: 'list-bonus-check-tips', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 tips', size: 'md',
        muted: "5 tips for the",
        punch: "{bonus} check.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'tip 1', size: 'md',
        muted: "1.",
  ...
  // C207 — 5 mistakes new freelancers make (glass-dark · mistakes)
  { id: 'C207', slug: 'list-new-freelancer-mistakes', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 mistakes', size: 'md',
        muted: "5 mistakes",
        punch: "new {freelancers} make.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
        punch: "No {business}\nbank account.",
  ...
  // C208 — 5 business-funding application mistakes (black · mistakes)
  { id: 'C208', slug: 'list-funding-application-mistakes', theme: 'black', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 mistakes', size: 'md',
        muted: "5 mistakes on a",
        punch: "{funding} application.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
        punch: "Personal credit\nunder {680.}",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'mistake 2', size: 'md',
        muted: "2.",
      ...
      { tpl: 'A', eyebrow: 'mistake 3', size: 'md',
        muted: "3.",
        punch: "Mixed personal\n+ {business} expenses.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'mistake 4', size: 'md',
        muted: "4.",
        punch: "Skipping {pre-qualification.}\n(Soft pull = free.)",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'mistake 5', size: 'md',
        muted: "5.",
  ...
  // C209 — 5 mistakes that turn a good month into a leak (glass-dark · mistakes)
  { id: 'C209', slug: 'list-good-month-leak-mistakes', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 mistakes', size: 'md',
        muted: "5 mistakes that turn",
        punch: "a good month\ninto a {leak.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
        punch: "Spending {before}\nsplitting.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'mistake 2', size: 'md',
        muted: "2.",
        punch: "Skipping the\n{reserve} top-up.",
      ...
      { tpl: 'A', eyebrow: 'mistake 3', size: 'md',
        muted: "3.",
        punch: "Treating windfall\nas {spendable.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'mistake 4', size: 'md',
        muted: "4.",
        punch: "Lifestyle {bump}\nafter one big check.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'mistake 5', size: 'md',
        muted: "5.",
        punch: "Floor + tax\ncomes {second.}",
  ...
  { id: 'C210', slug: 'list-emergency-fund-benefits', theme: 'glass', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'benefit 2', size: 'md',
        muted: "2.",
        punch: "Surprises become\n{inconveniences.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'benefit 3', size: 'md',
        muted: "3.",
        punch: "3-6 months {free}\nto find new clients.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'benefit 4', size: 'md',
        muted: "4.",
        punch: "Less {reactive}\ndecision-making.",
  ...
  // C211 — 4 benefits of per-deposit tax routing (green · benefits)
  { id: 'C211', slug: 'list-per-deposit-tax-benefits', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '4 benefits', size: 'md',
        muted: "4 benefits of",
        punch: "{per-deposit}\ntax routing.",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'benefit 1', size: 'md',
        muted: "1.",
        punch: "The bucket grows\n{automatically.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'benefit 2', size: 'md',
        muted: "2.",
        punch: "April is paperwork.\n{Not panic.}",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'benefit 3', size: 'md',
        muted: "3.",
        punch: "Quarterlies arrive\n{funded.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'benefit 4', size: 'md',
        muted: "4.",
        punch: "You never owe\n{interest} to the IRS.",
  ...
  { id: 'C269', slug: 'income-in-waves', theme: 'page', format: 'tiktok', slides: [
      ...
      { tpl: 'A', eyebrow: 'inconsistent income', size: 'md',
        muted: "You don't know\nwhen the next\ncheck lands.",
        punch: "So you {hold on.}",
        meta: '2 / 10' },
      { tpl: 'A', eyebrow: 'inconsistent income', size: 'md',
        muted: "Money sits. Leaks.",
        punch: "Day 30.\n{$1,000 gone.}",
        meta: '3 / 10' },
      { tpl: 'A', eyebrow: 'inconsistent income', size: 'md',
        muted: "Debt won't shrink.",
        punch: "Savings won't\n{start.}",
        meta: '4 / 10' },
  ...
  // ── Stats carousels (added 2026-05-14 — data-led multi-slide narratives) ──
  // Sourced from docs/statistics.md. Each carousel = 6-7 slides. Hook → build → Able reframe → CTA.
  { id: 'CS01', slug: 'stat-77-million-explained', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "77 million Americans\nget paid differently\n{every month.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'The data', size: 'md',
        muted: "That's about 1 in 3\nworking adults.",
        punch: "Source: {Federal Reserve.}",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'The gap', size: 'md',
        muted: "Every budgeting app",
        punch: "was built for\nthe {other 2.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'The assumption', size: 'md',
        muted: "Assume a paycheck.\nAssume a Friday.",
        punch: "Assume a\n{steady amount.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'The reality', size: 'md',
        muted: "If your income lands\nin deposits,",
        punch: "{none} of that fits.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'The fix', size: 'md',
        muted: "The fix isn't\nmore discipline.",
        punch: "It's a system built\nfor the {77 million.}",
        meta: '6 / 7' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "Built for inconsistent\n{income.}",
        meta: 'becomeable.app/get-able' },
  ] },

  { id: 'CS02', slug: 'stat-87-struggle-explained', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "87% of Americans\nstruggle to manage\n{their spending.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Also true', size: 'md',
        muted: "91.8% worry\nabout their budget.",
        punch: "Source: {LendingTree 2026.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'The catch', size: 'md',
        muted: "Only 1 in 3",
        punch: "has a budget\nthat {actually works.}",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'The reframe', size: 'md',
        muted: "When 87% fail,",
        punch: "it's not 87 individual\n{willpower problems.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The truth', size: 'md',
        muted: "It's a {category gap.}",
        punch: "Tools built for a workforce\nthat no longer exists.",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "Built for the way you\n{actually} get paid.",
        meta: 'becomeable.app/get-able' },
  ] },

  { id: 'CS03', slug: 'stat-five-numbers', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "5 numbers that\nexplain {your finances.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: '01', size: 'md',
        muted: "77M Americans",
        punch: "get paid differently\n{each month.}",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: '02', size: 'md',
        muted: "89% of households",
        punch: "see income swings\n{every month.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: '03', size: 'md',
        muted: "60% of freelancers",
        punch: "worry about\n{irregular pay.}",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: '04', size: 'md',
        muted: "Only 13% feel",
        punch: "{confident}\nabout their money.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: '05', size: 'md',
        muted: "87% struggle",
        punch: "to {manage} spending.",
        meta: '6 / 7' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "This is a\n{structure} problem.\nNot a willpower one.",
        meta: 'becomeable.app/get-able' },
  ...
  { id: 'CS04', slug: 'stat-confidence-gap', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "Only 13% of Americans\nfeel {confident}\nabout money.",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
        muted: "77% feel {anxious}",
        punch: "about their finances.",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
        muted: "88% report",
        punch: "{financial stress}\nin 2026.",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
        muted: "9 in 10 consumers",
        punch: "report {financial stress.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The point', size: 'md',
        muted: "That's not a\ndiscipline gap.",
        punch: "That's a\n{system gap.}",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
  ...
  { id: 'CS05', slug: 'stat-freelancer-worry', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "60% of freelancers\nworry about\n{irregular income.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
        muted: "Nearly half wish",
        punch: "pay was\n{more consistent.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
      ...
      { tpl: 'A', eyebrow: 'The pattern', size: 'md',
        muted: "Three numbers.",
        punch: "One {underlying} problem.",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The reality', size: 'md',
        muted: "Income lands\nwhen it lands.",
        punch: "Bills {don't wait.}",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'freelance', size: 'md',
  ...
  { id: 'CS06', slug: 'stat-paycheck-brackets', theme: 'black', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "53% of Americans\nlive paycheck\nto {paycheck.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Under $50K', size: 'md',
        muted: "72.8% of those",
        punch: "earning {under $50K.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'Over $150K', size: 'md',
        muted: "Even 20.6% of those",
        punch: "earning {over $150K.}",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'The insight', size: 'md',
        muted: "Paycheck-to-paycheck",
        punch: "is not an\n{income problem.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The truth', size: 'md',
        muted: "It's a {structure} problem.",
        punch: "Earn more without a system?\nYou leak more.",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "Plug the {leak} first.\nThen scale up.",
        meta: 'becomeable.app/get-able' },
  ] },

  { id: 'CS07', slug: 'stat-gig-economy-growth', theme: 'green', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "70 million Americans\nnow work in the\n{gig economy.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Of those', size: 'md',
        muted: "27.7 million work",
        punch: "full-time as\n{independents.}",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'The shift', size: 'md',
        muted: "More than {double}",
        punch: "the 2020 number.",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'What changed', size: 'md',
        muted: "Income arrives\nin deposits,",
        punch: "not in {paychecks.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The gap', size: 'md',
        muted: "Old budgeting tools",
        punch: "weren't built\n{for this.}",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "Floor-First Budgeting\n{was.}",
        meta: 'becomeable.app/get-able' },
  ] },

  { id: 'CS08', slug: 'stat-89-percent-swings', theme: 'glass-dark', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "89% of US households\nsee their income\nswing {every} month.",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'The median', size: 'md',
        muted: "Typical swing:",
        punch: "{36%.}\nUp or down.",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'In real terms', size: 'md',
        muted: "A third of your income",
        punch: "{moves}\nmonth to month.",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'The math', size: 'md',
        muted: "A monthly budget",
        punch: "{doesn't survive} that.",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The fix', size: 'md',
        muted: "A per-deposit system",
        punch: "{does.}",
        meta: '5 / 6' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
        punch: "Every deposit,\n{already sorted.}",
  ...
  { id: 'CS09', slug: 'stat-88-million-crisis', theme: 'page', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "88 million Americans\nare struggling or\n{in crisis.}",
        meta: '1 / 6' },
      { tpl: 'A', eyebrow: 'Also', size: 'md',
        muted: "77% experienced",
        punch: "a {financial setback}\nlast year.",
        meta: '2 / 6' },
      { tpl: 'A', eyebrow: 'But also', size: 'md',
        muted: "83% are focused",
        punch: "on what they\n{can control.}",
        meta: '3 / 6' },
      { tpl: 'A', eyebrow: 'The signal', size: 'md',
        muted: "Intent is {high.}",
        punch: "Tools haven't\n{caught up.}",
        meta: '4 / 6' },
      { tpl: 'A', eyebrow: 'The fix', size: 'md',
        muted: "The answer is\n{structural,}",
  ...
  { id: 'CS10', slug: 'stat-volatility-every-bracket', theme: 'white', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "Volatility doesn't care\nwhat you {earn.}",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'Proof 1', size: 'md',
        muted: "20.6% of households",
        punch: "earning {over $150K}\nlive paycheck-to-paycheck.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'Proof 2', size: 'md',
        muted: "5.6 million independents",
        punch: "earn over {$100K.}",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'Proof 3', size: 'md',
        muted: "Their income still",
        punch: "{swings}\nmonth to month.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'The point', size: 'md',
        muted: "Income volatility",
        punch: "is {not}\nlow income.",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'The reframe', size: 'md',
        muted: "Income volatility",
...
// ─────────────────────────────────────────────────────────
// RESERVED — held for later (Paul flagged + reserved 2026-05-13)
// Topics where Able does not yet help (credit-edu) or content that
// could imply Able does more than tax bucket/classify/export (tax-edu).
// Re-approve later by moving back into window.CAROUSELS.
// ─────────────────────────────────────────────────────────
window.RESERVED_CAROUSELS = [
  // C29 — What is a 1099-K? (white · pricing)
  { id: 'C29', slug: '1099-k', theme: 'white', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "What is\na {1099-K}?",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'mixed', size: 'md',
  ...
  { id: 'C31', slug: 'home-office', theme: 'page', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
  ...
  { id: 'C32', slug: 'schedule-c', theme: 'white', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "{Schedule C}\nin 6 slides.",
        meta: '1 / 7' },
      { tpl: 'B', eyebrow: 'mixed', size: 'md',
  ...
  { id: 'C33', slug: 'se-deductions', theme: 'glass', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
        punch: "Deductions\nyou might {miss}.",
        meta: '1 / 7' },
  ...
  { id: 'C47', slug: 'quarterly-taxes-primer', cat: 'Edu', theme: 'white', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'B', eyebrow: 'Swipe →', size: 'md',
  ...
  { id: 'C145', slug: 'learn-fico-vs-vantagescore', theme: 'white', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
  ...
  { id: 'C146', slug: 'learn-hard-vs-soft-inquiries', theme: 'page', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Soft pull:",
  ...
  { id: 'C148', slug: 'learn-automate-payments', theme: 'black', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Payment history:",
        punch: "{35%}\nof your score.",
        meta: '1 / 5' },
  ...
  { id: 'C149', slug: 'learn-build-credit-scratch', theme: 'glass', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Thin file?",
  ...
  { id: 'C150', slug: 'learn-dispute-errors', theme: 'page', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
  ...
  { id: 'C155', slug: 'learn-1099-nec', theme: 'white', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'tax', size: 'md',
        muted: "1099-NEC.",
        punch: "Non-Employee\n{Compensation.}",
        meta: '1 / 5' },
  ...
  { id: 'C156', slug: 'learn-1099-k', theme: 'page', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'tax', size: 'md',
        muted: "1099-K.",
  ...
  { id: 'C158', slug: 'learn-home-office', theme: 'green', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'tax', size: 'md',
  ...
  { id: 'C159', slug: 'learn-se-tax-deductions', theme: 'glass', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'tax', size: 'md',
        muted: "Self-employed?",
        punch: "{16 deductions}\nmost people miss.",
        meta: '1 / 5' },
  ...
  { id: 'C160', slug: 'learn-bad-month-quarterly', theme: 'black', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'tax', size: 'md',
  ...
  // C174 — Credit mix and account age (white · credit)
  { id: 'C174', slug: 'learn-credit-mix-age', theme: 'white', flagged: 'credit-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Last 25% of your score:",
        punch: "account {age}\n+ credit {mix.}",
        meta: '1 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Never close",
        punch: "your {oldest} card.\nEver.",
        meta: '2 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Dormant card?",
        punch: "Run one {streaming}\ncharge a month.",
        meta: '3 / 5' },
      { tpl: 'A', eyebrow: 'credit', size: 'md',
        muted: "Ideal mix:",
  ...
  // C199 — 5 home office deduction mistakes (black · mistakes)
  { id: 'C199', slug: 'list-home-office-mistakes', theme: 'black', flagged: 'tax-edu', format: 'tiktok', slides: [
      { tpl: 'A', eyebrow: '5 mistakes', size: 'md',
        muted: "5 mistakes",
        punch: "with the {home office}\ndeduction.",
        meta: '1 / 7' },
      { tpl: 'A', eyebrow: 'mistake 1', size: 'md',
        muted: "1.",
        punch: "Mixed-use space.\n{Kitchen} doesn't count.",
        meta: '2 / 7' },
      { tpl: 'A', eyebrow: 'mistake 2', size: 'md',
        muted: "2.",
        punch: "{Not regular} use.\nOccasional doesn't qualify.",
        meta: '3 / 7' },
      { tpl: 'A', eyebrow: 'mistake 3', size: 'md',
        muted: "3.",
        punch: "Not {exclusive.}\nThe guest room fails.",
        meta: '4 / 7' },
      { tpl: 'A', eyebrow: 'mistake 4', size: 'md',
        muted: "4.",
        punch: "Trying both methods\n{same year.}",
        meta: '5 / 7' },
      { tpl: 'A', eyebrow: 'mistake 5', size: 'md',
        muted: "5.",
        punch: "Skipping it because\nof the {audit myth.}",
        meta: '6 / 7' },
      { tpl: 'A', eyebrow: '5 mistakes', size: 'md',
        punch: "Free for\n{30 days.}",
        meta: 'becomeable.app/get-able' },
...
window.BRANDSCRIPT = [
  ...
  { id: 'B17', slug: 'paralysis-dont-move-it', cat: 'Paralysis', theme: 'glass-dark', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "You don't move the money",
    punch: "because you don't know\nwhen the {next check}\nis coming." },

  { id: 'B18', slug: 'paralysis-nothing-decision', cat: 'Paralysis', theme: 'page', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "A little here.\nA little there.",
    punch: "{Nothing} feels\nlike a decision." },

  { id: 'B19', slug: 'paralysis-400-gone', cat: 'Paralysis', theme: 'black', tpl: 'A', eyebrow: 'mixed', size: 'md',
  ...
  // ── Solution / mechanic ──
  { id: 'B22', slug: 'solution-every-deposit-routed', cat: 'Solution', theme: 'green', tpl: 'A', eyebrow: 'mixed', size: 'md',
  ...
  // ── New identity ──
  { id: 'B33', slug: 'identity-pay-down-slow-months', cat: 'New identity', theme: 'green', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "I am able to pay down debt,",
    punch: "even on {slow months.}" },

  { id: 'B34', slug: 'identity-save-no-second-guess', cat: 'New identity', theme: 'page', tpl: 'A', eyebrow: 'mixed', size: 'md',
    muted: "I am able to save",
    punch: "without {second-guessing.}" },

  { id: 'B35', slug: 'identity-predict-whats-coming', cat: 'New identity', theme: 'white', tpl: 'A', eyebrow: 'mixed', size: 'md',
