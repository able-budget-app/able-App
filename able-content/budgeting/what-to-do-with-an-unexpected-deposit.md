...
meta_title: "Unexpected Deposit: What to Do With It | Able"
meta_description: "Why surprise deposits disappear before you allocate them, the 24-hour routing rule that captures them, and the 4 question filter that puts every dollar to work."
target_keyword: "unexpected deposit allocation"
secondary_keywords:
  - surprise income freelancer
  - unexpected payment routing
...
internal_links:
  ...
  - /budgeting/handling-a-windfall/
  - /budgeting/the-good-month-rules/
  - /business/building-a-business-reserve/
cta: Start free trial
---

# What to Do With an Unexpected Deposit
...
1. Within 24 hours of the deposit landing, apply your standard per-deposit allocation. Tax bucket, floor, reserve, debt, pay-self.

2. If after the standard allocation there is still a surplus (because the deposit was larger or because some buckets are already full), apply the 4-question filter (below) to decide where the surplus goes.

3. The routing decision is documented. A note in your tracking system, a quick journal entry, anything that creates a record.

4. The remaining "free" portion, if any, is moved to a designated discretionary account. Not to operating, where it would commingle with everyday spending.
...
Standard per-deposit allocation routes:
- Tax bucket: $360 (30 percent)
- Floor: $300 (25 percent)
- Reserve: $120 (10 percent)
- Debt/savings: $120 (10 percent)
- Pay-self: $300 (25 percent)
...
Standard per-deposit allocation routes (same percentages):
- Tax: $1,050
- Floor: $875
- Reserve: $350
- Debt/savings: $350
...
See [How to Handle a Windfall on Variable Income](/budgeting/handling-a-windfall/) for the windfall-specific framework.
...
The fix: see the [Good Month Rules](/budgeting/the-good-month-rules/) for the broader pattern. The 24-hour routing rule is the tactical version.
...
- [How to Handle a Windfall on Variable Income](/budgeting/handling-a-windfall/)
- [The Good Month Rules](/budgeting/the-good-month-rules/)
