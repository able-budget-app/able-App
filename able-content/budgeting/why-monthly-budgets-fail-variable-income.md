...
Every deposit, the moment it lands, splits into fixed percentages:
- Tax bucket (25 to 35 percent depending on bracket)
- Floor bucket: bills, rent, essentials (20 to 30 percent)
- Reserve bucket: smoothing for slow months (5 to 15 percent)
- Debt or savings (5 to 15 percent)
- Free spending: what's left (15 to 30 percent)
...
Full breakdown of how this works: [The Per-Deposit Method](/budgeting/per-deposit-method-explained/).
...
For couples with one variable-income spouse and one W-2 spouse, full detail in [Couples on Variable Income](/budgeting/couples-on-variable-income/).
...
Able is per-deposit allocation as a system. You set the percentages once. Every deposit triggers the routing. The buckets fill automatically. The monthly stress of reconciliation disappears, and the savings/tax/reserve buckets fund themselves.
