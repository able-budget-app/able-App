...
meta_title: "Mid-Month Financial Check Routine | Able"
meta_description: "Why month-end is too late to fix problems, the 15-minute mid-month routine that catches them earlier, and the 5 specific things to check on day 15."
target_keyword: "mid month financial check"
secondary_keywords:
  - mid month budget review
  - monthly money check in
  - financial routine self employed
...
internal_links:
  - /budgeting/
  - /business/end-of-quarter-financial-checkup/
  - /budgeting/per-deposit-method-explained/
  - /business/year-end-financial-routine/
  - /budgeting/tracking-recurring-charges/
cta: Start free trial
---

# The Mid-Month Financial Check
...
- Unexpected large charges
- Subscription renewals you forgot about
- Duplicate charges
- Authorization holds that have not cleared
- Charges from merchants you do not recognize (possible fraud)
...
- Transfer money between accounts to close a gap
- Adjust the per-deposit allocation percentage for the next deposit
- Cancel a subscription
- Dispute a fraudulent charge
- Skip a planned discretionary purchase for the back half of the month
...
- Do I have what I need to finish the month cleanly?
- Are there any immediate adjustments to make?

**Quarterly review:**

- How are trends developing?
- Are my percentages right for the current business?
- What strategic changes should I make for next quarter?

The two are complementary. The mid-month check handles short-term operations. The quarterly review handles direction. See [End-of-Quarter Financial Checkup](/business/end-of-quarter-financial-checkup/) for the quarterly framework.
...
- [End-of-Quarter Financial Checkup](/business/end-of-quarter-financial-checkup/)
- [The Per-Deposit Method](/budgeting/per-deposit-method-explained/)
- [Year-End Financial Routine](/business/year-end-financial-routine/)
- [Tracking Recurring Charges](/budgeting/tracking-recurring-charges/)
