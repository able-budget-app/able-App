...
meta_title: "Good Month Rules for Variable Income | Able"
meta_description: "Why most freelancers blow a good month, the four-step rule sequence that captures the surplus, and the lifestyle-creep trap that erases years of strong months."
target_keyword: "good month variable income"
secondary_keywords:
  - what to do with extra income
  - high income month freelance
  - surplus income freelancer
...
Once the floor is solid, the next priority is the reserve. The target tiers (per the [Business Reserve](/business/building-a-business-reserve/) framework):
- Tier 1: 1 month of operating expenses
- Tier 2: 3 months
- Tier 3: 6 months
...
> Before adding any recurring expense over $20 a month, the addition has to pass two tests:
> 1. Could I still afford it in my worst recent month?
> 2. What am I giving up to fund it?
