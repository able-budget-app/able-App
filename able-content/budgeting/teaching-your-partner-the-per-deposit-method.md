...
internal_links:
  - /budgeting/
  - /budgeting/couples-on-variable-income/
...
# Teaching Your Partner the Per-Deposit Method
...
The pattern that fails: one person learns the per-deposit method, gets excited, sets up the buckets, and then expects the partner to absorb the change without much discussion. The partner sees new accounts, new transfers, new conversations about money percentages, and either pushes back or quietly opts out.
...
After the explanation, listen. Your partner will have reactions:
- "What does this change for me?"
- "Why now?"
- "What if I want to spend extra and the bucket says no?"
- "Are you saying I have been spending too much?"
- "What about the things I already pay for?"
...
Many couples settle on a "purchase over $X requires discussion" rule. The threshold depends on income, but typical ranges:
- Lower-income households: $100 to $250
- Middle-income households: $300 to $500
- Higher-income households: $500 to $1,000
...
A 20 to 30 minute review at the same time each month. Both partners look at:
- Where are the buckets?
- Are the percentages still right?
- What is coming up that requires planning?
- Anything to adjust?
...
"I do not want to budget" is general. The specific version might be:
- "I do not want to feel constrained."
- "I do not want a system that judges my spending."
- "I tried this before and it failed."
- "I do not want more meetings about money."
...
- [Couples on Variable Income](/budgeting/couples-on-variable-income/)
