...
meta_title: "Scope Creep Defense for Freelancers | Able"
meta_description: "Why scope creep is the silent margin killer, the four kinds of creep to watch for, and the scripts that hold the line without poisoning the relationship."
target_keyword: "scope creep freelance"
secondary_keywords:
...
- The client is a longstanding, high-value relationship and the request is genuinely tiny (15 minutes or less).
- The request stems from your mistake or oversight (a missed detail, an inadequate spec).
- The cumulative absorbed requests for this client are under 5 percent of project scope so far.

**When not to absorb:**

- The request is from a client you are already feeling resentful about.
- The cumulative absorbed requests are above 5 percent of project scope.
- The client is new and you are setting precedent.
- The request is "small" from the client's framing but actually takes hours.
...
- [How to Fire a Bad Client](/business/firing-a-bad-client/)
