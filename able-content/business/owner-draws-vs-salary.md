...
1. Every deposit into your business account triggers a percentage allocation to a "pay-self" bucket. (See [The Per-Deposit Method](/budgeting/per-deposit-method-explained/).)

2. The pay-self bucket accumulates. By the end of the month, it has the total month's pay-self amount in it.

3. On a fixed day each month (the 1st, the 15th, whatever), you transfer a fixed amount from pay-self to your personal checking. This is your "paycheck."
...
Full detail in [How to Pay Yourself a Steady Paycheck From an Unsteady Business](/budgeting/pay-yourself-steady-paycheck/).
...
- [LLC vs Sole Prop: Which Should You Choose?](/business/llc-vs-sole-prop/)
