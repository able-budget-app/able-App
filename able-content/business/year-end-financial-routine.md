...
meta_title: "Year-End Financial Routine for Self-Employed | Able"
meta_description: "The December and January checklist that closes the year cleanly. Tax moves, deduction harvesting, retirement contributions, and the year-over-year audit."
target_keyword: "year end checklist self employed"
secondary_keywords:
  - year end tax planning freelance
  - december tax moves self employed
...
internal_links:
  ...
  - /business/retirement-saving-variable-income/
  - /business/setting-prices-variable-income/
  - /taxes/
cta: Start free trial
---

# The Year-End Financial Routine
...
Adjust the percentages now, while the data is fresh. Common adjustments:
- Tax percentage: up if you owed at year-end, down if you over-funded
- Reserve percentage: up if reserve did not grow enough, down if reserve is at target
- Retirement percentage: up if retirement was under-funded, with annual contribution limits in mind
- Pay-self percentage: up if take-home felt tight, down if revenue allowed more reserve building
...
- [Retirement Saving on Variable Income](/business/retirement-saving-variable-income/)
