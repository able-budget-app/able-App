...
meta_title: "Pay Yourself First When You're in Debt | Able Learn"
meta_description: "The standard advice says pay off debt before you pay yourself. That advice is wrong. Here is why you start paying yourself first even when you're in debt."
target_keyword: "pay yourself first while in debt"
secondary_keywords:
  - pay yourself first debt
...
This is the in-debt edition of the [Pay Yourself First course](/learn/pay-yourself-first/).
...
If you have not seen the foundational article yet, [What Pay Yourself First Actually Means](/learn/pay-yourself-first/what-pay-yourself-first-means/) explains why the system runs on every deposit, not at the end of the month.
...
For the broader debt strategy this fits inside, see the [Get Out of Debt course](/learn/get-out-of-debt/) and specifically [Debt Snowball vs Debt Avalanche](/learn/get-out-of-debt/debt-snowball-vs-debt-avalanche/) to pick the payoff order.
...
**You paid off the highest-interest debt entirely.** If your remaining debt is below 8 percent, you can run [the standard percentage decision tree](/learn/pay-yourself-first/pay-yourself-first-percentage/) again. The urgency is lower.
...
**What if my minimum debt payments are barely covered now?**
Then your bills bucket already includes the minimums and your surplus is small. Five percent of a small surplus is a small dollar amount. That is fine. A $20 owner pay this week is still a non-zero owner pay this week.

**What if the debt is from the business itself, like a line of credit?**
Same rule. Business debt and personal debt are both debt. The 5 percent floor on owner pay still applies. You are not paying yourself instead of paying the business obligation. You are paying yourself in addition to honoring the obligation, with a smaller percentage.

**What if my partner thinks I should put 100 percent against debt?**
Show them the failure modes above. The all-or-nothing approach feels disciplined and fails in real life. The 5 percent approach feels less aggressive and pays off the debt faster on average because it survives surprises.
...
- [Debt Snowball vs Debt Avalanche](/learn/get-out-of-debt/debt-snowball-vs-debt-avalanche/)
