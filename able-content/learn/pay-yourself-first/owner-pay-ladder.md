...
meta_title: "The Owner Pay Ladder: 5% to a Real Salary | Able Learn"
meta_description: "Pay yourself first is not a fixed percentage forever. Here is the ladder that takes you from 5% on every deposit to a real owner salary on a real schedule."
target_keyword: "owner pay progression"
secondary_keywords:
  - owner pay ladder
  - pay yourself first stages
...
This article is the ladder. Five rungs, what each one looks like, and the trigger that moves you to the next. It is the long-arc chapter of the [Pay Yourself First course](/learn/pay-yourself-first/).
...
If you are still picking your starting percentage, see [How to Pick Your Pay Yourself First Percentage](/learn/pay-yourself-first/pay-yourself-first-percentage/) before this article.
...
**What it looks like:** Same per-deposit mechanism, percentage doubled. The personal account fills faster. The first real reach into priority 2 of the [priority stack](/learn/pay-yourself-first/what-to-do-with-owner-pay/) (debt elimination or extended cushion) starts here.
...
The single most important signal that it is time to drop a rung: the smoothing reserve had to release multiple times in the last 6 months, or owner pay accidentally got transferred back to operating to cover a fire (mistake 5 in the [common mistakes article](/learn/pay-yourself-first/pay-yourself-first-mistakes/)).
...
**What if I want to skip rungs?**
You can, with caution. Going from rung 2 to rung 4 (per-deposit 10 percent to fixed monthly salary) requires a smoothing reserve big enough to cover the salary in slow months. If the reserve is not there yet, you are setting up a fall. If it is, you can leap.

**What if I run a partnership and partners are at different rungs?**
Each partner picks their own rung. The business funds both partners according to their respective ownership percentages and pay arrangements. Partner A can be on rung 3 while partner B is on rung 4.

**What if I take a step back, like dropping from rung 3 to rung 2?**
That is a feature, not a failure. The ladder works in both directions. Dropping a rung in response to genuine signal is the discipline working. Cycling up and down based on mood is mistake 3 from the [common mistakes article](/learn/pay-yourself-first/pay-yourself-first-mistakes/).

**What if I am at rung 5 and the business has a very bad year?**
The S-corp salary is fixed in advance for tax purposes (a "reasonable salary"). You can adjust it for next year if revenue has structurally declined. In a single bad year, the salary holds and distributions go to zero. That is exactly how S-corps are supposed to work.

For deeper context on the business owner's perspective generally, see [How to Pay Yourself as a Business Owner With Variable Income](/business/).
...
- [What to Do With Your Owner Pay (The Priority Stack)](/learn/pay-yourself-first/what-to-do-with-owner-pay/)
- [Profit First vs Pay Yourself First](/learn/pay-yourself-first/profit-first-vs-pay-yourself-first/)
