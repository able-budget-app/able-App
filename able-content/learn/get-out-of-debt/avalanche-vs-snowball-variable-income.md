...
secondary_keywords:
  ...
  - debt avalanche freelance
  - which debt method works
...
# Avalanche vs. Snowball on Variable Income
...
3. Put all extra payment toward the debt with the highest interest rate.
4. When the highest-rate debt is cleared, roll its minimum + your extra into the next-highest-rate debt.
...
4. When the smallest is cleared, roll its minimum + your extra into the next-smallest balance.
5. Continue until all debts are paid.
