...
You must be at least 18 years old (or the age of majority in your jurisdiction) to use the Service. By agreeing to these Terms you represent that you meet that requirement and that the information you provide is accurate.
...
### 3.6 Failed payments
If a payment fails we will retry. If retries continue to fail, your subscription may be downgraded or canceled.

### 3.7 Payment processor
Payments are processed by Stripe. By providing a payment method you also agree to Stripe's terms: https://stripe.com/legal/consumer

---

## 4. What Able is and is not

**Able is a budgeting and planning tool.** It helps you organize income, bills, debts, and savings goals that you enter yourself.

**Able is not financial advice.** We are not a registered investment adviser, accountant, tax advisor, or fiduciary. Coach replies, allocation suggestions, and any other output inside the Service are informational and based on the numbers you provide. You are responsible for your own financial decisions. Consult a qualified professional for personalized advice.

**Able does not move money.** We do not initiate payments, transfers, or transactions on your behalf. You pay bills, transfer savings, and make payments through your own bank or institution.

**Able is not a bank.** We do not hold funds.

---

## 5. AI Coach

The AI Coach feature generates replies using large language models. Its output may be wrong, incomplete, or inappropriate. Do not rely on Coach replies as professional advice. Do not share information through Coach that you would not want sent to our AI provider (see our Privacy Policy for details).

We may limit Coach usage (for example, a daily message cap) to keep the Service sustainable.
...
- Interfere with the Service's operation, circumvent rate limits, or probe for vulnerabilities without our written permission.
- Use the Service to send spam, phishing, or malware.
- Use the Service to train a competing AI model on our output.
- Scrape, copy, or republish our content in bulk.
...
You keep ownership of the data you enter into the Service (bills, debts, notes, etc.). You grant us a limited license to host, store, transmit, and display that data solely to operate and improve the Service for you.
...
The Service itself, including its design, code, logos, and text we write (such as Learn lesson content), is owned by us and protected by copyright and other laws. You may use it only as permitted by these Terms.

We grant you a limited, non-exclusive, non-transferable license to use the Service for personal use while your subscription is active.
...
- We reasonably believe continuing to provide the Service to you creates legal or security risk for us or other users.
- We discontinue the Service (we will give reasonable notice).

On termination, your access ends and your data may be deleted per our Privacy Policy's retention section.

---

## 10. Warranties and disclaimers

THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF HARMFUL COMPONENTS, OR THAT ANY INFORMATION IT PROVIDES IS ACCURATE OR COMPLETE.
...
We may update these Terms when our product, pricing, or practices change or when required by law. If we make material changes we will notify you by email and by a notice in the app at least 14 days before the changes take effect. Continuing to use the Service after changes take effect means you accept the updated Terms.
